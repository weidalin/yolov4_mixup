...
if __name__ == "__main__":
    ...
    Cfg.train_label = '/home/weida/datasets/crowdhuman/annotation_train.odgt'
    Cfg.val_label = '/home/weida/datasets/crowdhuman/annotation_val.odgt'
    # dataset = Yolo_dataset(Cfg.train_label, Cfg)
    dataset = CrowdHuman(Cfg.train_label, Cfg)
    for i in range(100):
