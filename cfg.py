...
_BASE_DIR = '/home/weida/datasets/crowdhuman/'
Cfg.dataset_dir = '/home/weida/datasets/crowdhuman/'
...
Cfg.blur = 0
Cfg.gaussian = 0
Cfg.boxes = 3000  # box num
Cfg.TRAIN_EPOCHS = 300
Cfg.train_label = os.path.join(_BASE_DIR, 'annotation_train.odgt')
Cfg.val_label = os.path.join(_BASE_DIR, 'annotation_val.odgt')
